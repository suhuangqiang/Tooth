package com.example.tooth.widget;
...
public class PickerView extends View
{
	 ...
	 * text֮�����minTextSize֮��
	 */
	public static final float MARGIN_ALPHA = 0.8f;
	/**
	 * �Զ��ع����м���ٶ�
	 */
	...
	private float mMaxTextSize = 2;
	private float mMinTextSize = 1;

	private float mMaxTextAlpha = 255;
	private float mMinTextAlpha = 120;

	private int mColorText = Color.parseColor("#FE6B26");
