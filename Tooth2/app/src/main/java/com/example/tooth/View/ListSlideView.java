...
public class ListSlideView extends ListView {
        ...
        switch (action) {
			...
			/* 右侧菜单的长度 */
                if (this.mode == MODE_RIGHT) {
                    ...
                    Log.i("slide","右侧菜单的长度:"+rightLength);
                }
    ...
    private void scrollLeft() {
        isSlided = true;
        final int delta = (rightLength*2 - itemView.getScrollX());
        Log.i("slide","delta:"+delta+"----rightLength:"+rightLength+"----"+Math.abs(delta));
